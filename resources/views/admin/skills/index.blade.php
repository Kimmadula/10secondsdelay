...
@section('subtitle', 'Manage skills and categories')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('admin.skill.store') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @csrf
            <div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Manage existing skills and categories</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($skills as $skill)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $skill->users_count ?? 0 }} users</div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="text-sm text-gray-500">No skills found.</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
